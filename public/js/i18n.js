...
(function () {
  ...
  const STR = {
    uz: {
      ...
      'cat.texnologiya': 'Texnologiya', 'cat.madaniyat': 'Madaniyat', 'cat.dunyo': 'Dunyo', 'cat.jamiyat': 'Jamiyat',
      ...
      loading: 'Yuklanmoqda…',
      loadError: "Yangiliklarni yuklab bo'lmadi. Server ishlayotganini tekshiring.", retry: 'Qayta urinish',
      // AI
    ...
    ru: {
      ...
      'cat.texnologiya': 'Технологии', 'cat.madaniyat': 'Культура', 'cat.dunyo': 'Мир', 'cat.jamiyat': 'Общество',
      ...
      loading: 'Загрузка…',
      loadError: 'Не удалось загрузить новости. Проверьте, что сервер запущен.', retry: 'Повторить',
